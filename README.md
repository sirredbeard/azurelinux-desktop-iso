...
**Warning: the installer clears and repartitions its target disk.** On real
hardware, this means Azure Linux Desktop replaces the contents of the
selected drive. Back up data first and disconnect drives that must not be
touched.
