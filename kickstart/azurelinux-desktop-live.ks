...
# Fedora's generic kernel is intentionally exposed only to this disposable
# control. The normal Fedora repos still exclude the kernel family.
repo --name=fedora43-kernel-control --baseurl=https://dl.fedoraproject.org/pub/fedora/linux/releases/43/Everything/x86_64/os/ --cost=1 --includepkgs=kernel,kernel-core,kernel-modules,kernel-modules-core,kernel-modules-extra
